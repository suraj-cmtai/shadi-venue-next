...
const links = [
  { name: "Dashboard", href: "/dashboard/marketing", icon: LayoutDashboard, badge: null },
  { name: "Leads", href: "/dashboard/marketing/leads", icon: Users, badge: null },
  { name: "Hotel Enquiry", href: "/dashboard/marketing/hotel-enquiry", icon: MapPin, badge: null },
  { name: "Vendor Enquiry", href: "/dashboard/marketing/vendor-enquiry", icon: Package, badge: null },
